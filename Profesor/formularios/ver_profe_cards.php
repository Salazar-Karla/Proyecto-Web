...
FROM profesor a
JOIN usuario u ON a.id_usuario = u.id_usuario where a.id_usuario = $id
";
...
<div class="contenedor-flex">
  ...
  <div class="perfil-contenedor">
    ...
    <div class="contenido-datos">
      <p class="dato">
        <strong><?= htmlspecialchars($profesores[0]['nombre']) . " " . htmlspecialchars($profesores[0]['ap_Pat']) . " " . htmlspecialchars($profesores[0]['ap_Mat']) ?></strong>
      </p>
      <p class="dato">
  ...
  <section class="bienvenida">
    <div class="bienvenida-texto">
      ...
      <p>🔸Generar asignaciones de formularios y exámenes.</p>
      ...
      <p>¡Gracias por formar parte del equipo de profesores! Tu labor es clave para lograr una buena educación.</p>
    </div>
