...
<head>
    ...
    <title>Menú rompecabezas</title>
    
    <link rel="stylesheet" href="./menuPuzzle.css">k
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            for (let i = 1; i <= 9; i++) {
                ...
                boton.onclick = () => {
                    window.location.href = `./Trayect${i}/puzzle.html`; // Cambia esto si tus archivos tienen otro nombre
